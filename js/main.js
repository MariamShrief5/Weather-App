...
navigator.geolocation.getCurrentPosition(async function (position) {
    ...
    try {
        ...
        if (weatherCondition === "rain") {
            ...
            weatherImgs.src = "./images/rain.png";
        } else if (weatherCondition === "clear" || weatherCondition === "clear sky") {
            weatherImg.src = "./images/sun.png";
            weatherImgs.src = "./images/sun.png";
        } else if (weatherCondition === "snow") {
            weatherImg.src = "./images/snow.png";
            weatherImgs.src = "./images/snow.png";
        } else if (weatherCondition === "clouds" || weatherCondition === "smoke") {
            weatherImg.src = "./images/cloud.png";
            weatherImgs.src = "./images/cloud.png";
        } else if (weatherCondition === "mist" || weatherCondition === "Fog") {
            weatherImg.src = "./images/mist.png";
            weatherImgs.src = "./images/mist.png";
        } else if (weatherCondition === "haze") {
            weatherImg.src = "./images/haze.png"  ;
            weatherImgs.src = "./images/haze.png";
        }
